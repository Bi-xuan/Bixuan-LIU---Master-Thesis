...
# Initialization
n <- 4
Lambda_1 <- rbind(c(0.5,0.7,0,0),c(0,0.6,0,0.3),c(0.4,0,0.4,0),c(0,0,0,0.3))  # Changable coefficients
Lambda_2 <- rbind(c(0.5,0,0,0),c(0.3,0.6,0,0),c(0,0,0.4,0.7),c(0,0,0.5,0.3))  # Changable coefficients
