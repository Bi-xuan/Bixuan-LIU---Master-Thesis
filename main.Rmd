...
J_G_1 <- rbind(J_n2_1[-3,],c(1,0,0,1))
...
J_G_2 <- rbind(J_n2_2[-2,],c(1,0,0,1))
...
rankMatrix(J_G_2)
print("The ranks are the same, so the matroids are the same.")
```
Note: I also tried to change the coefficients in Lambda, and it did not change the result.
